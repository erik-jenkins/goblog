...
// ErrCaErrCannotConnectDB is returned when a connection to the database cannot be made.
var ErrCannotConnectDB = errors.New("Cannot connect to the given database.")

// NewDB opens a connection to the MySQL database indicated by the dsn. If
